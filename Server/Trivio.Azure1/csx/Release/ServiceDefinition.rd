...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="Trivio.Azure1" generation="1" functional="0" release="0" Id="6e5a7915-9fbe-4f06-80b7-3136c117fd00" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="Trivio.Azure1Group" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="Trivio" generation="1" functional="0" release="0" software="C:\Users\neils\Documents\BU\Spring 2017\EC464\Code\Trivio\Server\Trivio.Azure1\csx\Release\roles\Trivio" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="7a9e106a-3a86-4778-a406-01e817baf2fa" ref="Microsoft.RedDog.Contract\ServiceContract\Trivio.Azure1Contract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="d009582a-9b19-4933-b3fb-0c994b7edea6" ref="Microsoft.RedDog.Contract\Interface\Trivio:Endpoint1@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/Trivio.Azure1/Trivio.Azure1Group/Trivio:Endpoint1" />
          </inPort>
        </interfaceReference>
